...
//        DataStream<String> lines = env.addSource(kafkaSource);
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> summed = keyBy.map(new RichMapFunction<Tuple2<String, Integer>, Tuple2<String, Integer>>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ...
                ValueStateDescriptor<Integer> descriptor = new ValueStateDescriptor<Integer>("np-sum-state", Types.INT);
            ...
            public Tuple2<String, Integer> map(Tuple2<String, Integer> value) throws Exception {
                ...
                int count = value.f1;
                Integer hisData = state.value();
                if (hisData != null) {
                    hisData += count;
                    state.update(hisData);
                    return Tuple2.of(word, hisData);
                } else {
                    state.update(count);
