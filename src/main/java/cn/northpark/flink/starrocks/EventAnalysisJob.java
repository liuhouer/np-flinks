...
public class EventAnalysisJob {
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.executeSql(
                "CREATE TABLE event_summary3_jj (" +
                        "id STRING, " +
                        "event_name STRING, " +
                        "page_title STRING, " +
                        "user_id INT, " +
        ...
        // 插入StarRocks
        tableEnv.executeSql("INSERT INTO event_summary3_jj SELECT distinct_id as id ,event_name, page_title, user_id, time_at, " +
